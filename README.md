...
```sh
curl -fsSL https://install.boltz.bio/boltz-api/install.sh | BOLTZ_API_VERSION=0.15.3 sh
```

```powershell
$env:BOLTZ_API_VERSION = "0.15.3"; irm https://install.boltz.bio/boltz-api/install.ps1 | iex
```
