...
```sh
curl -fsSL https://install.boltz.bio/boltz-api/install.sh | BOLTZ_API_VERSION=0.14.1 sh
```

```powershell
$env:BOLTZ_API_VERSION = "0.14.1"; irm https://install.boltz.bio/boltz-api/install.ps1 | iex
```
