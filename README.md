...
```sh
curl -fsSL https://install.boltz.bio/boltz-api/install.sh | BOLTZ_API_VERSION=0.10.2 sh
```

```powershell
$env:BOLTZ_API_VERSION = "0.10.2"; irm https://install.boltz.bio/boltz-api/install.ps1 | iex
```
